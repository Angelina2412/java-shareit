...
public class ItemRequestController {
    ...
    @GetMapping
    public List<ItemRequestDto> getUserRequests(@RequestHeader("User-Id") Long userId) {
        return itemRequestService.getUserRequests(userId);
    }

    // Эндпоинт для получения всех запросов, созданных другими пользователями
    @GetMapping("/all")
    public Page<ItemDto> getAllRequests(@RequestHeader("User-Id") Long userId,
    ...
    public ItemRequestDto getRequestById(@RequestHeader("User-Id") Long userId,
